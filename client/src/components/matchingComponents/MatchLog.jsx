...
const MatchLog = () => {
  ...
  return (
    <div className="MatchLog w-[316px] h-[1024px] px-[16px]">
      <div className="flex justify-center">
        <div className="w-[282px] h-[187px] text-center bg-[#F6F7FC] rounded-xl mt-[36px] border-2 border-[#D6D9E4]">
      ...
      <h1 className="mt-[48px] text-[#2A2E3F] text-[24px] font-bold">Chat with Merry Match</h1>
    </div>
  );
};
