...
const EditModal = (close) => {
  ...
  return (
      ...
      <div ref={ref} className="editModal bg-white w-[900px] h-[700px] rounded-3xl flex z-30 absolute items-center justify-center font-[400]  mt-[20%]">
          ...
          <div className="w-[100%] h-[20%] ">
            ...
            <div className="[100%] h-[100%] overflow-y-scroll ">
              <p className="text-[16px]  ">
                ...
                จะไม่โทร และสุดท้ายที่ในหัวใจมันร่ำร้อง
                อยากจะมองจะมองหน้าเธออีกสักที ก่อนจะลา เธอไป คนใจดำหน้าตาดี
                ขอโทษเธอสักทีจากหัวใจ และมีหนึ่งคำ ที่ยังค้างข้างใน
