...
function DeleteButton({ close }) {
  ...
  return (
    <div className="DeleteButton w-[33rem] h-[12.5rem] bg-white rounded-[24px] flex flex-col z-30 relative">
      ...
      <div className="w-[100%] h-[auto] ml-[5%] flex justify-start space-x-[5%]">
        ...
        <button className="w-[7.813rem] h-[3rem] text-[1rem] bg-[#C70039] rounded-[99px] lending-[150%] text-[white] font-[700]">
          No, I don’t
        </button>
      </div>
    </div>
